...
expect(rover.generatorWatts).toEqual(110);
  ...
  // 7 tests here!
// mode change check low power
it("response return by receiveMessage contains name of message", function() { 
...
// it("responds with false completed value when attempting to move in LOW_POWER mode", function() {
//   let commands = [new Command('MOVE', 9999)];
//   let message = new Message('Status check input', commands);
//   let rover = new Rover(98382);
//   let response = rover.receiveMessage(message);
//   expect(response.results[1].completed).toEqual(false);
...
//   let rover = new Rover(98382);
//   let response = rover.receiveMessage(message);
//   expect(rover.position).toEqual(999999);
//   expect(response.results[0].completed).toEqual(true);
// });

// });
// test line to check status check low power
